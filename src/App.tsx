              ...
              >
                <div className="lg:w-1/2 p-8 md:p-16 lg:p-20 text-white">
                  ...
                  <div className="space-y-6 md:space-y-8 mb-10 md:mb-12">
                    ...
                    <div className="flex items-start gap-4 md:gap-6">
                      <div className="w-10 h-10 md:w-12 md:h-12 bg-[#25D366]/10 rounded-xl md:rounded-2xl flex items-center justify-center shrink-0">
                      ...
                      <div>
                        ...
                        <p className="text-[#25D366] font-bold text-lg md:text-xl">(11) 99287-6219</p>
                      </div>
                    </div>
                  </div>
