...
const ServiceCard: React.FC<{ service: any; index: number }> = ({ service, index }) => {
  return (
    <motion.div 
      ...
      className="group bg-white rounded-[32px] overflow-hidden flex flex-col shadow-lg border border-gray-100 transition-all duration-500 relative h-[420px]"
    >
      ...
      {/* Top Image Section - 240px height to preserve original aspect ratio without cropping heads */}
      ...
      {/* Content Block Below - tight spacing to eliminate white space */}
      <div className="flex-1 p-5 md:p-6 flex flex-col items-center text-center justify-between">
        <div className="mb-2">
  ...
  return (
    <div className="relative overflow-x-hidden bg-white">
      ...
      <Header onNavClick={handleGlobalNavClick} />
          ...
          <section id="inicio" className="relative min-h-[480px] md:min-h-screen flex flex-col pt-28 md:pt-32 pb-12 md:pb-20">
